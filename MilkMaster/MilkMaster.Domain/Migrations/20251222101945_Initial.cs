    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CattleCategories", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MilkCartonUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TagNumber = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CattleCategoryId = table.Column<int>(type: "int", nullable: true),
                    BreedOfCattle = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Age = table.Column<int>(type: "int", nullable: false),
                    LitersPerDay = table.Column<float>(type: "real", nullable: false),
                    MonthlyValue = table.Column<float>(type: "real", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Cattle_CattleCategories_CattleCategoryId",
                        column: x => x.CattleCategoryId,
                        principalTable: "CattleCategories",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_CattleCategories_CattleCategoryId",
                        column: x => x.CattleCategoryId,
                        principalTable: "CattleCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                name: "BreedingStatuses",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CattleId = table.Column<int>(type: "int", nullable: false),
                    PragnancyStatus = table.Column<bool>(type: "bit", nullable: false),
                    LastCalving = table.Column<DateTime>(type: "datetime2", nullable: false),
                    NumberOfCalves = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BreedingStatuses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BreedingStatuses_Cattle_CattleId",
                        column: x => x.CattleId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CattleOverviews", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CattleOverviews_Cattle_CattleId",
                        column: x => x.CattleId,
                        principalTable: "Cattle",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductId = table.Column<int>(type: "int", nullable: false),
                    Quantity = table.Column<int>(type: "int", nullable: false),
                    UnitSize = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    PricePerUnit = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderItems_Units_UnitsId",
                        column: x => x.UnitsId,
                        principalTable: "Units",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BreedingStatuses_CattleId",
                table: "BreedingStatuses",
                column: "CattleId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Cattle_CattleCategoryId",
                table: "Cattle",
                column: "CattleCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_CattleOverviews_CattleId",
                table: "CattleOverviews",
                column: "CattleId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_CattleCategoryId",
                table: "Products",
                column: "CattleCategoryId");
